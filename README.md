...
I cloned Pulumi and exported the mermaid diagrams from CodeViz into this repo. Here's the top level system architecture, the rest of the diagrams are in component-architecture:
```mermaid
graph TB
    User((User))
